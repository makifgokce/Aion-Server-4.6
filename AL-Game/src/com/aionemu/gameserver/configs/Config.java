...
public class Config {
	...
	public static void load() {
		try {
			...
			log.info("[Config] Loading: " + main + "/veteran_rewards.properties");
	...
	public static void reload() {
		try {
			...
			ConfigurableProcessor.process(VeteranRewardConfig.class, mainProps);
			log.info("[Config] Reload: " + main + "/veteran_rewards.properties");

		} catch (Exception e) {
			log.error("[Config] Can't reload configuration: ", e);
			throw new Error("[Config] Can't reload configuration: ", e);
		}
	}
}
