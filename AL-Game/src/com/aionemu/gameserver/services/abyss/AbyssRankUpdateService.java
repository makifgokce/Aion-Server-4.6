...
public class AbyssRankUpdateService {
    ...
    private void updateLimitedRanks() {
        updateAllRanksForRace(Race.ASMODIANS, AbyssRankEnum.GRADE9_SOLDIER.getRequiredAp());
        updateAllRanksForRace(Race.ELYOS, AbyssRankEnum.GRADE9_SOLDIER.getRequiredAp());
    }
    ...
    private void selectRank(AbyssRankEnum rank, List<Entry<Integer, Integer>> playerApEntries) {
        for(Entry<Integer, Integer> playerAp : playerApEntries) {
