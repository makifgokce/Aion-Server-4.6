...
public class SM_FRIEND_RESPONSE extends AionServerPacket {
	...
	/**
	 * %0 sana bir arkadaşlık isteği gönderdi.
	 */
	public static final int TARGET_OFFLINE_ADDED = 0x11;
	/**
	 *
	 */
	public static final int TARGET_OFFLINE_DENIED = 0x12;
	/**
	 * The target become a note.
	 */
	public static final int TARGET_NOTE = 0x18;
