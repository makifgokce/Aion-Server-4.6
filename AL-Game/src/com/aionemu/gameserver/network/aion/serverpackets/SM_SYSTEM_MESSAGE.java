...
public final class SM_SYSTEM_MESSAGE extends AionServerPacket {
     ...
     */
	/**
	* Upgrade of %0 has been cancelled.
	*/
	...
	/**
	* %0 has been upgraded. +%num1 level has been added.
	*/
	...
	/**
	* The upgrade of %0 has failed and was set to level 0.
	*/
	...
	public static SM_SYSTEM_MESSAGE STR_MSG_F2P_VENDOR_SELL_RESTRICT(String value0) {
		return new SM_SYSTEM_MESSAGE(1700016, value0);
	}
	public static SM_SYSTEM_MESSAGE STR_MSG_F2P_PERSONAL_SHOP_OPEN_RESTRICT(String value0) {
		return new SM_SYSTEM_MESSAGE(1700024, value0);
	}

	public static final SM_SYSTEM_MESSAGE STR_F2P_ACCOUNT_TRIAL = new SM_SYSTEM_MESSAGE(1753002);
	public static final SM_SYSTEM_MESSAGE STR_F2P_ACCOUNT_FREE = new SM_SYSTEM_MESSAGE(1753003);
	public static final SM_SYSTEM_MESSAGE STR_F2P_ACCOUNT_BRONZE = new SM_SYSTEM_MESSAGE(1753004);
	public static final SM_SYSTEM_MESSAGE STR_F2P_ACCOUNT_SILVER = new SM_SYSTEM_MESSAGE(1753005);
 ...
 // new 4.8 stigma system start
     ...
     * @return
     */
    public static SM_SYSTEM_MESSAGE STR_MSG_QUEST_COMPLETE_ERROR_QUEST_ITEM_RETRY(int itemId) {
        return new SM_SYSTEM_MESSAGE(1401066, new DescriptionId(itemId));
    }
