...
public class CM_CASTSPELL extends AionClientPacket {
    ...
    protected void readImpl() {
        ...
        switch (targetType) {
            case 0:
            case 3: // 1606 RecallInstantEffect
            case 4:
            case 87:
                targetObjectId = readD();
                break;
            case 1: // Sorc/ Delayed Heatwave I
                x = readF();
                y = readF();
                z = readF();
                break;
    ...
    protected void runImpl() {
        ...
        } else if(obj instanceof Player && template.hasResurrectEffect() && ((Player) obj).getLifeStats().isAlreadyDead()) {
            player.getController().useSkill(template, targetType, x, y, z, hitTime, level);
        }
    }
}
