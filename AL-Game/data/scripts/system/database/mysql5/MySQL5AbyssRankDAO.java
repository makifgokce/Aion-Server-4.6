...
public class MySQL5AbyssRankDAO extends AbyssRankDAO {
	...
	public Map<Integer, Integer> loadPlayersAp(final Race race, final int lowerApLimit) {
		final Map<Integer, Integer> results = new FastMap<>();
