...
public class IdeResonator3AI2 extends NpcAI2 {
	...
	private void startpower() {
		if(!IdeResonator3AI2.this.getEffectController().hasAbnormalEffect(21371)) {
			skillTask = ThreadPoolManager.getInstance().scheduleAtFixedRate(new Runnable() {
				@Override
				public void run() {
					AI2Actions.targetCreature(IdeResonator3AI2.this, getPosition().getWorldMapInstance().getNpc(231073));
					AI2Actions.useSkill(IdeResonator3AI2.this, 21257);
				}
			}, 3000, 5000);
		} else {
			AI2Actions.targetCreature(IdeResonator3AI2.this, getPosition().getWorldMapInstance().getNpc(231073));
			AI2Actions.useSkill(IdeResonator3AI2.this, 21258);
		}
	}
